...
public class Throttler : Throttler<bool>
{
    ...
    public Throttler(int interval, bool intervalFromStart = false, bool resetIntervalOnException = false)
...
public class Throttler<T>
{
    ...
    /// <param name="resetIntervalOnException">true - if an error occurs, ignore call and do not wait for the time interval for next call</param>
    public Throttler(int interval, bool isIntervalSinceInvokeTime = false, bool resetIntervalOnException = false)
    {
