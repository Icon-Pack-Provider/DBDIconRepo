...
namespace IconPackAPI.Internal
{
    internal static class CSV
    {
        ...
        {
            using (var csv = new CsvHelper.CsvReader(new StreamReader(GetCSVStream(key)),
        ...
        {
            using (var csv = new CsvHelper.CsvReader(new StreamReader(GetCSVStream("power.csv")),
                CultureInfo.InvariantCulture))
            {
        ...
        {
            using (var csv = new CsvHelper.CsvReader(new StreamReader(GetCSVStream("addon.csv")),
                CultureInfo.InvariantCulture))
            {
        ...
        {
            using (var csv = new CsvHelper.CsvReader(new StreamReader(GetCSVStream("perk.csv")),
                CultureInfo.InvariantCulture))
            {
